...
public class DataHandler {
	...
	//This class is responsible for handling the data deletion, insertion or editing.
	...
	public ObservableList<Employee> getAllLeaves() throws SQLException {
	        ...
	        try (PreparedStatement statement = conn.prepareStatement(query);
	            ...
	            while (resultSet.next()) {
	                ...
	                employee.getLeaves().getLeavesList().add(leave); 
	...
	public void insertEmployee(Employee employee) throws SQLException {
	        ...
	        // Generate random hours worked between 25 and 40
	        //However in the real world there will be another application that manages the punch in and punch out mechanism
